...
public class DOMWriteDLWGQZ {
	...
	private static void writeElementsToFileAndConsole() {
		try {
            ...
            rootElement.setAttribute("xsi:noNamespaceSchemaLocation", "XMLSchemaDLWGQZ.xsd");
	...
	private static void addHelyszin(Document document, Element rootElement, String hkod, String nev, String ferohely, 
		...
		helyszin.appendChild(stadionElement);
		
		Element varosElement = createElement(document, "Város", varos);
		helyszin.appendChild(varosElement);
